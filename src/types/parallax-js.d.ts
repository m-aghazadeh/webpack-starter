declare module 'parallax-js' {
    export default class Parallax {
        private inputElement?: string | HTMLElement | Element | null;
        ...
        public destroy(): void;
        public version(): void;
        public setInputElement(element: string | HTMLElement | Element | null): void;
    ...
    export interface IParallaxOptions {
        ...
        hoverOnly?: boolean;
        inputElement?: string | HTMLElement | Element | null;
